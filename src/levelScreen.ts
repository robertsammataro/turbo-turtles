...
export default class levelScreen extends Phaser.Scene {
    ...
    sortingButton?: Phaser.GameObjects.Image
    ...
    create()
    {
        ...
        this.sortingButton = this.add.image(400, 450, 'playnow');
        this.add.text(335, 425, 'Sorting', { font: "bold 40px Arial", color: 'black'});
        this.datatypeButton.setInteractive();
        this.indicesButton.setInteractive();
        this.sortingButton.setInteractive();
        ...
        this.sortingButton.on('pointerup', () => {
            this.scene.start('QuizScene');
		})
    }
